                 ...
                 <div class="card-body">
                     <form method="POST" action="{{ url('admin-product-update/' . $Products->id) }}"
                         ...
                         <ul class="nav nav-tabs" id="myTab" role="tablist">
                             ...
                             <li class="nav-item">
                                 <a class="nav-link" id="pstatus-tab" data-toggle="tab" href="#pstatus" role="tab"
                                     aria-controls="pstatus" aria-selected="false">Delivery Charges & Product Status</a>
                             </li>
                             <li class="nav-item">
                                 <a class="nav-link" id="Additional_Information-tab" data-toggle="tab"
                                     href="#Additional_Information" role="tab" aria-controls="Additional_Information"
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <input type="text" class="form-control" name="url"
                                                 placeholder="Custom URL" value="{{ $Products->url }}">
                                         </div>
                                     </div>
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <select class="form-control" name="rating">
                                                 <option value="{{ $Products->rating }}" disabled>{{ $Products->rating }}
                                                 </option>
                                 ...
                                 <div class="row px-5 py-3">
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <img src="{{ asset('Uploads/Products/' . $Products->image1) }}" width="50px;"
                                                 alt="{{ $Products->image1 }}" />
                                         </div>
                                     </div>
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <img src="{{ asset('Uploads/Products/' . $Products->image2) }}" width="50px;"
                                                 alt="{{ $Products->image2 }}" />
                                         </div>
                                     </div>
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <img src="{{ asset('Uploads/Products/' . $Products->image3) }}" width="50px;"
                                                 alt="{{ $Products->image3 }}" />
                                         </div>
                                     </div>
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <img src="{{ asset('Uploads/Products/' . $Products->image4) }}" width="50px;"
                                                 alt="{{ $Products->image4 }}" />
                                         </div>
                                     </div>
                                     <div class="col-md-12">
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             ...
                                             <input type="number" class="form-control" name="delivery_charges" required
                                                 min="1" placeholder="Delivery Charges "
                                                 value="{{ $Products->delivery_charges }}">
                                         </div>
                                     </div>
