...
class UserController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $validation = $request->validate([
            ...
            'mno' => 'nullable|digits_between:8,20',
            'alternativemno' => 'nullable|digits_between:8,20',
    ...
    public function send_email(Request $request)
    {
        ...
        Mail::send(array('html' => 'emails.order_email'), $emailcontent, function ($message) use ($emailto, $subject, $recievername) {
