@extends('layout')
@section('title') GIFT STORE-Shipping,Returns @endsection
...
<h1 align="center" class="black-text col-md-12" style="font-weight:bold;">Shipping & Returns</h1>
  ...
  <p align="center">GIFT STORE will give more priority to the customer's happiness.We deliver the orders at the best quality with the best pricing</p>
  <div class="row text-center text-md-left">
    ...
    <p class="text-muted" style="margin-top:-20px;">
        <strong>
            ...
            <li>For any enquiry regarding your order you can directly contact us by using the contact us page.</li>
            </ul>
        </strong>
    </p>
    </div>
