    ...
    public function  order_proceed(Request $request)
    {
        ...
        if ($p_method != 'Online') {
            ...
            $emailbody = 'Your Order Was Placed Successfully<br>
    	                <p>Thank you for your order. We’ll send a confirmation when your order ships. Your estimated delivery date is 3-5 working days. If you would like to view the status of your order or make any changes to it, please visit Your Orders on <a href="https://www.db_store.com">db_store.com</a></p>
            ...
            //     $message->to($loginid, $name)->subject('Your db_store.com order ' . $id . ' is Confirmed');
