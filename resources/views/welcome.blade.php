    ...
    <div id="About" class="container-fluid" style="background:white;">
        ...
        <div class="row ">
            ...
            <div align="center" class="col-md-8 wow animated flash slow">
                <h1 class="black-text" style="font-weight:bold;">About of GIFT STORE</h1>
                ...
                <div class="row my-5" style="font-size:30px; font-family: 'Balsamiq Sans', cursive;">
                    <div class="col-md-6">
                        <ul align="center" style="list-style:none;">
                            <li><i class="fab fa-pagelines"></i>Stainless Steel</li><br>
                            <li><i class="fab fa-pagelines"></i>High Quality</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul align="center" style="list-style:none;">
                            <li><i class="fab fa-pagelines"></i>Scratch Resistant</li><br>
                            <li><i class="fab fa-pagelines"></i>LightWeight</li>
                        </ul>
                    </div>
                </div>
