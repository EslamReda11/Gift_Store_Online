...
@section('content')
    ...
    <div class="px-5 py-2" style="background:#1CD5E8;margin-top:5px; ">
        ...
        <p class="my-2"> <span class="fas fa-bars fa-1x" style="font-size:20px;cursor:pointer;color:black;"
                onclick="openNav()"></span> <a href="/" class="black-text">Home></a><a href="{{ url('dashboard') }}"
                class="black-text">Dashboard></a> <strong class="black-text"> <a href="" class="black-text">Profile
                </a> </strong> </p>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="javascript:void(0)" class="closebtn" onclick="closeNav()"
            style="color:white;font-size:30px;margin-left:20px;margin-top:80px;">x</a>
    ...
    <div class="container px-5">
        ...
        <h3 class="py-2  ">Edit My Profile</h3>
        <div class="row ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    @else
                                        <img src="{{ asset('Uploads/profiles/' . Auth::user()->image . '') }}"
                                            alt="{{ Auth::user()->image }}" class="img-fluid mx-5" style="width:50%">
                                    @endif
                                ...
                                <div class="col-md-12 py-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a data-toggle="modal" data-target="#openpasswordmodel"
                                            class="btaobtn btaobtn-outline-dark btaobtn-lg px-2 py-2"> Change Password </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ Auth::user()->address1 }}" name="address1"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ Auth::user()->address2 }}" name="address2"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ Auth::user()->mnumber }}" name="mno"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ Auth::user()->alternativemno }}"
                                            name="alternativemno" class="form-control">
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    <p class="close" data-dismiss="modal" aria-label="Close">
                        <button class="btaobtn btaobtn-danger">Try Again<i
