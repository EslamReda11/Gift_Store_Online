                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;"
                                        width="75%">
                                        &copy; GIFT STORE<br />
                                        <font color="#ffffff">For More Details please feel free to <a
                                                href="{{ url('Contact') }}"
                                                style="color: #ffffff;text-decoration:underline;">ContactUs</font></a>
                                    </td>
                                ...
                                {{-- <i class="fab fa-twitter"></i> --}}
                                                ...
                                                <td
                                                    style="font-family: Arial, sans-serif; font-size: 12px; font-weight: bold;">
                                                    <a href="https://www.facebook.com/eslam.zizo.9862"
                                                        style="color: #ffffff;">
