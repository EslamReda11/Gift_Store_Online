            ...
            <div class="modal-body">
                                ...
                                <table class="table table-hover">
                                    <tr>
                                        ...
                                        <form action="admin-Update-Shipping-Status" method="POST">
                                            ...
                                            <input list="Shipping_Status" name="Shipping_Status" id="Shipping_Status"
                                                value="{{ session('Shipping_Status') }}">
                                        ...
                                        <td>
                                            ...
                                            <form action="admin-Update-Payment-Status" method="POST">
                                                ...
                                                <select name="p_status">
                                                    <option value="{{ session('p_status') }}" hidden>
                                                        {{ session('p_status') }}</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="admin-Update-paymentmode-Status" method="POST">
                                                @csrf
                                                <input type="hidden" value="{{ session('Order_id') }}"
                                                    name="Order_id">


                                                <select name="paymentmode">
                                                    <option value="{{ session('paymentmode') }}" hidden>
                                                        {{ session('paymentmode') }}</option>
                ...
                <ul align="left" style="color:red">
                    @if (session('Order_Cancel_Status') == 1)
                        ...
                        <li>Click <a href="{{ url('admin-Order-Re-Cancel/' . session('Order_id') . '') }}">Here</a> to Re
                            Cancel the this Order</li>
                    @else
                        <li>
