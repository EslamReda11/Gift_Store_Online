        ...
        <div class="card  p-3 animated fadeInUp">
            ...
            <div class="row">
                ...
                <div class="row px-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="radio" name="Payment_Method" value="Online"> Online : <img
                ...
                <div class="col-md-12">
                    <div class="form-group">
                            <input type="radio" name="Payment_Method" value="Online"> Cash(Cash On Delivery) :
                    </div>
                </div>
            ...
            @if (session('cart'))
                ...
                @foreach (session('cart') as $id => $details)
                    ...
                    @php
                        $order_details = $order_details . '<br>' . ('Product Name:' . $details['item_name'] . ', Quantity: ' . $details['item_quantity'] . '<br> Price:' . $details['Final_Price']);
                    @endphp
                @endforeach
